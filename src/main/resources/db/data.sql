--superuser 1111
INSERT INTO member (member_id, password, name, phone, email, memberRole, memberStatus, birth, created_at, last_login_time)
...
-- board
INSERT INTO board (title, content, member_id, boardCategory, created_at, updated_at)
